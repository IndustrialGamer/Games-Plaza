...
public class ADMCommand implements CommandExecutor, Listener {
        ...
        if (command.getName().equalsIgnoreCase("ADM")) {
            ...
            if (args[0].equalsIgnoreCase("wl")) {
                if (args[1].equalsIgnoreCase("hb")) {
                    ...
                    p.sendMessage(ChatColor.BLUE + "ADM> " + ChatColor.GREEN + "A WhiteList foi habilitada");
                }
                if (args[1].equalsIgnoreCase("db")) {
                    Bukkit.getServer().setWhitelist(false);
                    p.sendMessage(ChatColor.BLUE + "ADM> " + ChatColor.GREEN + "A WhiteList foi desabilitada");
                }
                for (Player target : Bukkit.getOnlinePlayers()) {
                    if (args[1].equalsIgnoreCase("add") && args[2].equalsIgnoreCase(target.getName())) {
                        ...
                        p.sendMessage(ChatColor.BLUE + "ADM> " + ChatColor.GREEN + "O player " + ChatColor.DARK_PURPLE + target.getName() + " " + ChatColor.GREEN + "foi adicionado a WhiteList");
                    ...
                    if (args[1].equalsIgnoreCase("rmv") && args[2].equalsIgnoreCase(target.getName())) {
                        ...
                        p.sendMessage(ChatColor.BLUE + "ADM> " + ChatColor.GREEN + "O player " + ChatColor.DARK_PURPLE + target.getName() + " " + ChatColor.GREEN + "foi removido da WhiteList");
                    }
                }
            }
